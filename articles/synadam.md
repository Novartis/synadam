...
#> 
#> output_dir: '/tmp/RtmpmUn5S4/syn_output'
#> seed: 42
#> 
#> datasets:
#>   adae:
#>     dataset_type: "occds"
#>     path: '/tmp/RtmpmUn5S4/adam_data/adae.sas7bdat'
#>     id_cols: [USUBJID]
#>     seq_col: AESEQ
#>     flag_cols: []
...
#>   adlb:
#>     dataset_type: "bds"
#>     path: '/tmp/RtmpmUn5S4/adam_data/adlb.sas7bdat'
#>     id_cols: [USUBJID]
...
#>   adsl:
#>     dataset_type: "adsl"
#>     path: '/tmp/RtmpmUn5S4/adam_data/adsl.sas7bdat'
...
#> Loading dataset from /tmp/RtmpmUn5S4/adam_data/adsl.sas7bdat
...
#> Loading dataset from /tmp/RtmpmUn5S4/adam_data/adae.sas7bdat
...
#> Loading dataset from /tmp/RtmpmUn5S4/adam_data/adlb.sas7bdat
...
#> Saving study summary to /tmp/RtmpmUn5S4/file475c519edaa7.rds...
#> ----- Simulating adsl -----
#> Simulating column(s): treatment, flag
#> Simulating column(s): REGION1, REGION1N
#> Simulating column(s): STUDYID
...
#> Simulating column(s): BMIBL
#> Simulating column(s): TRTSDT
#> Saving adsl to /tmp/RtmpmUn5S4/syn_output/syn_adsl.rds...
#> ----- Simulating adae -----
...
#> Saving adae to /tmp/RtmpmUn5S4/syn_output/syn_adae.rds...
#> ----- Simulating adlb -----
...
#> Saving adlb to /tmp/RtmpmUn5S4/syn_output/syn_adlb.rds...
```
...
#> Glimpsing column(s): ANL01FL
#> Glimpsing column(s): ADT
#> Saving study summary to /tmp/RtmpmUn5S4/syn_output/study_summary.rds...
...
#>  $ seed           : int 42
#>  $ synadam_version: chr "0.3.2"
#>  $ glimpsed_at    : POSIXct[1:1], format: "2026-07-03 13:08:05"
...
#> Simulating column(s): BMIBL
#> Simulating column(s): TRTSDT
#> Saving adsl to /tmp/RtmpmUn5S4/syn_output_split/syn_adsl.rds...
#> ----- Simulating adae -----
#> Simulating occurrence counts
#> Simulating sequence column
#> Simulating column(s): AESEV, AESEVN
...
#> Simulating column(s): ASTDT
#> Simulating column(s): AENDT
#> Saving adae to /tmp/RtmpmUn5S4/syn_output_split/syn_adae.rds...
#> ----- Simulating adlb -----
#> Simulating PARAM/VISIT and ADSL columns
#> Simulating column(s): param, visits
#> Simulating column(s): adsl, cols
...
#> Simulating column(s): BASE
#> Simulating column(s): CHG
#> Saving adlb to /tmp/RtmpmUn5S4/syn_output_split/syn_adlb.rds...
