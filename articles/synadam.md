...
#> 
#> output_dir: '/tmp/Rtmpj9Q6uH/syn_output'
#> seed: 42
#> 
#> datasets:
#>   adae:
#>     dataset_type: "occds"
#>     path: '/tmp/Rtmpj9Q6uH/adam_data/adae.sas7bdat'
#>     id_cols: [USUBJID]
#>     seq_col: AESEQ
#>     flag_cols: []
...
#>   adlb:
#>     dataset_type: "bds"
#>     path: '/tmp/Rtmpj9Q6uH/adam_data/adlb.sas7bdat'
#>     id_cols: [USUBJID]
...
#>   adsl:
#>     dataset_type: "adsl"
#>     path: '/tmp/Rtmpj9Q6uH/adam_data/adsl.sas7bdat'
...
#> Loading dataset from /tmp/Rtmpj9Q6uH/adam_data/adsl.sas7bdat
...
#> Loading dataset from /tmp/Rtmpj9Q6uH/adam_data/adae.sas7bdat
...
#> Loading dataset from /tmp/Rtmpj9Q6uH/adam_data/adlb.sas7bdat
...
#> Saving study summary to /tmp/Rtmpj9Q6uH/file47094127b32b.rds...
#> ----- Simulating adsl -----
#> Simulating column(s): treatment, flag
#> Simulating column(s): REGION1, REGION1N
#> Simulating column(s): STUDYID
...
#> Simulating column(s): BMIBL
#> Simulating column(s): TRTSDT
#> Saving adsl to /tmp/Rtmpj9Q6uH/syn_output/syn_adsl.rds...
#> ----- Simulating adae -----
...
#> Saving adae to /tmp/Rtmpj9Q6uH/syn_output/syn_adae.rds...
#> ----- Simulating adlb -----
...
#> Saving adlb to /tmp/Rtmpj9Q6uH/syn_output/syn_adlb.rds...
```
...
#> Glimpsing column(s): ANL01FL
#> Glimpsing column(s): ADT
#> Saving study summary to /tmp/Rtmpj9Q6uH/syn_output/study_summary.rds...
...
#>  $ seed           : int 42
#>  $ synadam_version: chr "0.3.3"
#>  $ glimpsed_at    : POSIXct[1:1], format: "2026-07-09 12:00:04"
...
#> Simulating column(s): BMIBL
#> Simulating column(s): TRTSDT
#> Saving adsl to /tmp/Rtmpj9Q6uH/syn_output_split/syn_adsl.rds...
#> ----- Simulating adae -----
#> Simulating occurrence counts
#> Simulating sequence column
#> Simulating column(s): AESEV, AESEVN
...
#> Simulating column(s): ASTDT
#> Simulating column(s): AENDT
#> Saving adae to /tmp/Rtmpj9Q6uH/syn_output_split/syn_adae.rds...
#> ----- Simulating adlb -----
#> Simulating PARAM/VISIT and ADSL columns
#> Simulating column(s): param, visits
#> Simulating column(s): adsl, cols
...
#> Simulating column(s): BASE
#> Simulating column(s): CHG
#> Saving adlb to /tmp/Rtmpj9Q6uH/syn_output_split/syn_adlb.rds...
